...
Public Class payment
    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As EventArgs) Handles Me.Load
        ...
        TextBox7.Text = (Int32.Parse(Session("selected_con")) * 1000).ToString
    End Sub
    ...
    Public Sub LogIn(sender As Object, e As EventArgs) Handles search.Click
        ...
        objCommand.CommandText = "insert into reservation(ship_no,total_containers,name,company_name,credit_card_no) values('" + Session("ship") + "','" + Session("selected_con") + "','" + TextBox1.Text.ToString() + "','" + TextBox2.Text.ToString() + "','" + TextBox6.Text.ToString() + "')"
